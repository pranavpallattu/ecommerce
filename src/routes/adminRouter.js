...
adminRouter.post(
  ...
  authMiddleware,
  adminMiddleware,
  categoryController.unListCategoryController,
);
adminRouter.put(
  "/category/softDelete/:id",
  authMiddleware,
  adminMiddleware,
  categoryController.softDeleteCategoryController,
);
adminRouter.get(
...
adminRouter.get("/categories/active",authMiddleware, adminMiddleware ,categoryController.getActiveCategoriesController);
...
adminRouter.put(
  ...
  authMiddleware,
  adminMiddleware,
  customerController.updateUserStatusController,
);
...
adminRouter.post(
  ...
  authMiddleware,
  adminMiddleware,
  couponController.addCouponController,
);
...
adminRouter.put(
  ...
  authMiddleware,
  adminMiddleware,
  couponController.updateCouponStatusController,
);
...
adminRouter.put(
  ...
  authMiddleware,
  adminMiddleware,
  couponController.editCouponController,
);
...
adminRouter.delete(
  ...
  authMiddleware,
  adminMiddleware,
  couponController.softDeleteCouponController,
);
...
adminRouter.put(
  "/orders/return/reject/:orderId/:itemId",
  authMiddleware,
  adminMiddleware,
...
adminRouter.get(
  ...
  authMiddleware,
  adminMiddleware,
  orderController.getReturnPendingRequests,
);
